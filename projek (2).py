...
def hiu():
    global value,pos_x_hiu, batas_kiri, pos_y_hiu, pos_y_kapalselam, darah, pos_x_kapalselam, pos_x_peluru, pos_y_peluru
    os.system('cls')
    ...
    toleransi = 10
    if pos_x_hiu in range (pos_x_peluru-toleransi, pos_x_peluru+toleransi) and  pos_y_hiu in range (pos_y_peluru-toleransi, pos_y_peluru+toleransi) :
        pos_x_hiu = 500
        value += 50
